  ...
  return (
    <div className="flex-1 space-y-6 max-w-7xl mx-auto w-full">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Certificates</h1>
      ...
      <Card className="rounded-2xl border-none shadow-sm bg-white overflow-hidden">
        <CardContent className="flex flex-col items-center justify-center h-[500px] text-center">
          ...
          <p className="text-slate-500 max-w-md">
            The Certificates feature is currently being built by our team. Check back soon for updates!
          </p>
        </CardContent>
      </Card>
    </div>
